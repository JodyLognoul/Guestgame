...
class __TwigTemplate_7ed71c335df8f56c7705665d1dd7cc15 extends Twig_Template
{
    ...
    public function block_table_footer($context, array $blocks = array())
    {
        ...
        if ((twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "admin"), "getExportFormats", array(), "method")) > 0)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["format"]) {
                // line 83
                echo "                                    <a href=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "admin"), "generateUrl", array("export", ($this->getAttribute($this->getAttribute($this->getContext($context, "admin"), "modelmanager"), "paginationparameters", array($this->getAttribute($this->getContext($context, "admin"), "datagrid"), 0, ), "method") + array("format" => $this->getContext($context, "format"))), ), "method"), "html", null, true);
                echo "\">";
    ...
    public function block_list_filters($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute($this->getAttribute($this->getContext($context, "admin"), "datagrid"), "filters")) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["filter"]) {
                ...
                // line 186
                echo $this->env->getExtension('form')->renderWidget($this->getAttribute($this->getAttribute($this->getContext($context, "form"), "getChild", array($this->getAttribute($this->getContext($context, "filter"), "formName"), ), "method"), "getChild", array("type", ), "method"));
                echo "</td>
                                <td class=\"filter-value\">";
                // line 187
                echo $this->env->getExtension('form')->renderWidget($this->getAttribute($this->getAttribute($this->getContext($context, "form"), "getChild", array($this->getAttribute($this->getContext($context, "filter"), "formName"), ), "method"), "getChild", array("value", ), "method"));
                echo "</td>
                            </tr>
                        ";
            }
            ...
            echo "                    </table>
                    ...
                    ";
            // line 194
            $context["foo"] = $this->getAttribute($this->getAttribute($this->getContext($context, "form"), "getChild", array("_page", ), "method"), "setRendered", array(), "method");
            // line 195
            echo "                    ";

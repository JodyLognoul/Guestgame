...
class CommentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ggDiscussionBundle:Comment')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ggDiscussionBundle:Comment')->find($id);
     ...
     * @Method("post")
     * @Template("ggDiscussionBundle:Comment:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("ggDiscussionBundle:Comment:edit.html.twig")
     */

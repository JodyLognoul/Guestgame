...
namespace gg\Bundle\SiteBundle\Controller;

use Symfony\Bundle\FrameworkBundle\Controller\Controller;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Method;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Route;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Template;
use gg\Bundle\SiteBundle\Entity\Site;
use gg\Bundle\SiteBundle\Form\SiteType;
...
class SiteController extends Controller {
    ...
    public function homepageAction() {           
        ...
        return $this->render('ggSiteBundle:Site:homepage.html.twig');
    }
    ...
    public function indexAction() {
        ...
        $entities = $em->getRepository('ggSiteBundle:Site')->findAll();
    ...
    public function showAction($id) {
        ...
        $entity = $em->getRepository('ggSiteBundle:Site')->find($id);
     ...
     * @Method("post")
     * @Template("ggSiteBundle:Site:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("ggSiteBundle:Site:edit.html.twig")
     */
